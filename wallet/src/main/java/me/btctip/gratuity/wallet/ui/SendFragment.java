...
import me.btctip.gratuity.coins.FiatType;
import me.btctip.gratuity.coins.Value;
import me.btctip.gratuity.coins.ValueType;
...
import me.btctip.gratuity.uri.CoinURI;
import me.btctip.gratuity.uri.CoinURIParseException;
...
import me.btctip.gratuity.wallet.tasks.MarketInfoPollTask;
import me.btctip.gratuity.wallet.ui.widget.AddressView;
import me.btctip.gratuity.wallet.ui.widget.AmountEditView;
import me.btctip.gratuity.wallet.util.ThrottlingWalletChangeListener;
import me.btctip.gratuity.wallet.util.UiUtils;
...
import static me.btctip.gratuity.coins.Value.canCompare;
import static me.btctip.gratuity.wallet.ExchangeRatesProvider.getRates;
import static me.btctip.gratuity.wallet.util.UiUtils.setGone;
import static me.btctip.gratuity.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, me.btctip.gratuity.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
