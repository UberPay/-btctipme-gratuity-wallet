package me.btctip.gratuity.util;
...
import me.btctip.gratuity.coins.FiatValue;
...
//    }
    ...
    /**
     * Parse a human readable fiat value to a {@link me.btctip.gratuity.coins.Value} instance.
     *
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
